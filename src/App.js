  ...
  render() {
    ...
    if(!this.state.available) {
      ...
      if(this.state.badAddrs){
        warn = <h2>Revise su billetera este bien escrita (copiar y pegar es la mejor opcion) </h2>
      }
      disp = <div><h1>Ingrese la direccion de su billetera</h1>
        <input id="newWallet" type="text" placeholder="0xap13jnh39873najo3h3" onChange={(e) => this.onUpdateHandler(e)} value={this.state.fundedAccount}/>
